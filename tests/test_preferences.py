...
class PreferenceUpdateTest(unittest.TestCase):
    ...
    def test_fallback_preserves_product_context_on_attribute_only_override(self) -> None:
        state = replace(
            ShoppingState.new("s1", {}),
        ...
        self.assertFalse(patch.reset_product_preferences)
        self.assertEqual(updated.category, "leg warmers")
        self.assertEqual(updated.preferences["material"], ("wool",))
